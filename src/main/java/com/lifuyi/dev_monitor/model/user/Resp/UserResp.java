...
public class UserResp {
    ...
    public UserResp(String id, String user_name, String user_password, String user_real_name, String user_phone, String user_status, String enterprise_name, Date register_time, Date update_time, String role_name) {
        this.id = id;
